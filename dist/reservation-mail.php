...
$subject = "【モデルハウス見学申し込み】お問い合わせがありました";
...
$require = array('モデルハウス', 'お名前', 'フリガナ', 'ご連絡先', 'メールアドレス', 'メールアドレス（確認用）', 'お問い合わせ内容');
...
この度は「モデルハウスの見学申し込み」にお問い合わせいただき、誠にありがとうございます。
          ...
          <div id="formWrap">
            ...
            <div>
              ...
              <div class="form__reset">
                <input class="form__reset-btn" type="button" value=" 入力画面に戻る " onClick="history.back()">
              </div>
            </div>
            <?php } else { ?>
